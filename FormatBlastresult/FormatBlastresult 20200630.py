...
for record in SeqIO.parse(sys.argv[1], "fasta"):
    ...
    leftstart=recombination_result[0][1]
    for j in range(n):
        if leftstart == recombination_result[j][1]:
            ...
            for i in range(1,n):
                ...
                rightstart=recombination_result[i][1]
                rightend=recombination_result[i][2]
                rightname=recombination_result[i][8]
                rightsubjectstart=recombination_result[i][3]
                rightsubjectend=recombination_result[i][4]
